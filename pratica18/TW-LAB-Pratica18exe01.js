...
function aguardar_preenchimento_formulario_cep () {
	//Preenche os campos do formulário de CEP com "...", enquanto consulta o Web
Service.
$("#rua").val ("...");
$("#bairro").val ("...");
$("#cidade").val ("...");
...
//Preenche os campos do furmulário de CEP com "...", enquanto consulta o
Webservice.
...
if (!("erro" in dados)) {
$("#msg").html ("").hide ();
//Atualiza os campos do formulário de CEP com os valores retornados
pela consulta.
